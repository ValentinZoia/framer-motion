...
const Carousel = () => {
    ...
    {/*
        Define una función nextSlide que incrementa el índice actual (currentIndex) en 1.
         Si el índice llega al final de la lista de imágenes (images), vuelve al inicio (índice 0).
    */}
    const nextSlide = () =>
    ...
    {/*
        Define una función prevSlide que decrementa el índice actual (currentIndex) en 1.
        Si el índice es menor que 0, vuelve al final de la lista de imágenes.
    */}
    const prevSlide = () => {
      setCurrentIndex(
    ...
    {/*
        Define una función selectSlide que establece el índice actual (currentIndex) al valor proporcionado (index). 
        También muestra las miniaturas (showThumbnails) durante 5 segundos.
    */}
       ...
       <div className="relative w-[50%] rounded-lg overflow-hidden">
        <motion.div
          className={`flex mb-[2rem] transition-opacity duration-300 ${
            showThumbnails || isHovered ? "opacity-100" : "opacity-0" //controlamos la opacidad basadas en los estados
          }`}
        >
